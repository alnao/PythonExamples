...
- Comandi per il test del job eseguendolo
    ```
    aws glue start-job-run --job-name InvertCSVDataJob
    aws glue get-job-runs --job-name InvertCSVDataJob --query JobRuns[*].[StartedOn,JobRunState,CompletedOn] --output table
