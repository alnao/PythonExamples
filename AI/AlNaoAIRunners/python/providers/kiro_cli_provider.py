...
class KiroCLIProvider(AbstractCLIProvider):
    ...
    def execute(self, prompt: str, log_cb, cwd: str = None) -> dict:
        ...
        try:
            ...
            return {"stdout": f"Error executing Kiro: {str(e)}", "stderr": str(e), "code": 1}
