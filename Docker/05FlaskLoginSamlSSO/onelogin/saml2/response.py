...
#                print ("is_valid passato, ritorno true3")
...
#                    print ("WARNING : Signature validation failed. SAML Response rejected")
#                    raise OneLogin_Saml2_ValidationError(
#                        'Signature validation failed. SAML Response rejected',
#                        OneLogin_Saml2_ValidationError.INVALID_SIGNATURE
#                    )
#                print ("is_valid passato, ritorno true4")
#            print ("is_valid passato, ritorno true")
            return True
