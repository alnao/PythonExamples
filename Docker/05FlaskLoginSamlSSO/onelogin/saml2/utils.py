...
from urllib.parse import urlsplit, urlunsplit # from urlparse import urlsplit, urlunsplit
...
class OneLogin_Saml2_Utils(object):
    ...
    def validate_xml(xml, schema, debug=False):
        ...
        :rtype: string
        """
        assert isinstance(xml, str) or isinstance(xml, Document) or isinstance(xml, etree._Element)
